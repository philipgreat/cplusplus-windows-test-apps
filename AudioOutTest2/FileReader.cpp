...
int CFileReader::Seek(int pos)
{
	return ::SetFilePointer(this->saveFile,pos,0,FILE_CURRENT);
}

int CFileReader::SeekAbsolutePosition(int pos)
{
	return ::SetFilePointer(this->saveFile,pos,0,FILE_BEGIN);
}
