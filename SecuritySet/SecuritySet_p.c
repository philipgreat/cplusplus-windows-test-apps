...
/* Object interface: IHaspKey, ver. 0.0,
   GUID={0xA31FF10C,0xB204,0x4231,{0x88,0x5B,0x62,0x1F,0x0C,0xC1,0x99,0x24}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IHaspKey_ServerInfo;
...
static const unsigned short IHaspKey_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IHaspKey_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IHaspKey_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IHaspKey_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IHaspKey_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(9) _IHaspKeyProxyVtbl = 
{
    &IHaspKey_ProxyInfo,
    &IID_IHaspKey,
    ...
    (void *)-1 /* IHaspKey::login */ ,
    (void *)-1 /* IHaspKey::applyToken */
};


static const PRPC_STUB_FUNCTION IHaspKey_table[] =
{
...
CInterfaceStubVtbl _IHaspKeyStubVtbl =
{
    &IID_IHaspKey,
    &IHaspKey_ServerInfo,
    9,
...
/* 52 */	NdrFcShort( 0x8 ),	/* 8 */
#ifndef _ALPHA_
/* 54 */	NdrFcShort( 0x14 ),	/* x86, MIPS, PPC Stack size/offset = 20 */
#else
			NdrFcShort( 0x28 ),	/* Alpha Stack size/offset = 40 */
#endif
/* 56 */	NdrFcShort( 0x0 ),	/* 0 */
...
/* 74 */	NdrFcShort( 0x2113 ),	/* Flags:  must size, must free, out, simple ref, srv alloc size=8 */
#ifndef _ALPHA_
...
const CInterfaceProxyVtbl * _SecuritySet_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IHaspKeyProxyVtbl,
    0
};

const CInterfaceStubVtbl * _SecuritySet_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IHaspKeyStubVtbl,
    0
};

PCInterfaceName const _SecuritySet_InterfaceNamesList[] = 
{
    "IHaspKey",
    0
};

const IID *  _SecuritySet_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _SecuritySet_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SecuritySet, pIID, n)

int __stdcall _SecuritySet_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_SecuritySet_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo SecuritySet_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SecuritySet_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SecuritySet_StubVtblList,
    (const PCInterfaceName * ) & _SecuritySet_InterfaceNamesList,
    (const IID ** ) & _SecuritySet_BaseIIDList,
    & _SecuritySet_IID_Lookup, 
    1,
    2,
