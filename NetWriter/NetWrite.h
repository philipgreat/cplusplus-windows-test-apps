...
public:
    ...
    HRESULT WritetoNet();
    HRESULT Init();
	void setCW( DWORD CWID1, DWORD CWID2, DWORD CW1, DWORD CW2, BYTE Ver ); /* heqy*/
...
private:
    ...
    HRESULT WriteScript();
private:
	BYTE btMSeries[ENCODE_LENGTH];   /*heqy*/
	DWORD dwCW2;
	DWORD dwCW1;
	DWORD dwCWID2;
	DWORD dwCWID1;
	BYTE btVer;
	BYTE dwVideomark[100]; /*heqy*/
