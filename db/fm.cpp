...
void fm::OnButtonDeleteItem() 
{

	
	if(::MessageBox(NULL,"请确认是否删除? 删除后没有任何方法恢复!","警告",MB_YESNO|MB_DEFBUTTON2|MB_ICONINFORMATION)==IDNO){
		return ;
	}
	...
	sql="delete  from help where type=\'"+type+"\' and title =\'"+title+"\'  ";
